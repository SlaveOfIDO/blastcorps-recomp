...
*/
ultramodern::input::connected_device_info_t get_connected_device_info(int controller_num) {
    bool singleplayer = recompinput::players::is_single_player_mode();
...
std::vector<recomp::GameEntry> supported_games = {
    {
        ...
        .is_enabled = false,
        // .decompression_routine = blast::decompress, TODO: only enable this when mod support is being worked on
...
int main(int argc, char** argv) {
    ...
    REGISTER_FUNC(recomp_get_native_framerate_config);
    REGISTER_FUNC(recomp_get_draw_distance_config);
    REGISTER_FUNC(recomp_get_fog_distance_config);
